...
- [ ] **Phase 25: Tech Debt Cleanup** — Fix exit codes, remove dead code, correct configOnly verifier bypass, populate Slack history
- [ ] **Phase 26: Git Worktree Isolation** — WorktreeManager with create/remove/prune, workspaceDir seam, readOnly Docker flag
